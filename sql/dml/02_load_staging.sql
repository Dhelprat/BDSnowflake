...
TRUNCATE TABLE stg_mock_data_raw RESTART IDENTITY;

COPY stg_mock_data_raw (
    source_id, customer_first_name, customer_last_name, customer_age, customer_email,
    ...
    product_size, product_brand, product_material, product_description, product_rating,
